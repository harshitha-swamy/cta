                                ...
                                <div class="tab-content acc-tab-content" id="myTabAutoContent">
                                    ...
                                    <div class="tab-pane fade" id="new-tab-html-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                         <!-- <div class="row">
                                                ...
                                                <div class="tab-contents-cta">
                                                    <div class="file-upload-wrapper">
                                                        <label for="fileUpload" class="file-upload-box">
                                                            ...
                                                            <div class="upload-text">
                                                            <p>Drag your file here or <span class="browse">browse</span></p>
                                                            <small>JPG, PNG, SVG and WEBP formats, up to 10 MB</small>
                                                            </div>
                                                            <input type="file" id="fileUpload" class="file-input" accept=".jpg,.png,.svg,.webp">
                                                        </label>

                                                        <div id="uploadedFile" class="uploaded-file"></div>
                                                    </div>
                                                    <p class="ortext">Or</p>
                                                    <a href="" class="browseCta">Browse from catalogue</a>
                                                    <div class="uploaded-file">
                                                        ...
                                                        <div class="uploadedContainer">
                                                            ...
                                                            <div class="imgInfo">
                                                                <p class="imgName">Start my deal.svg</p>
                                                                <p class="imgsize">266kb</p>
                                                            </div>
                                                            </div>
                                                    ...
                                                    <div class="editedSection">
                                                            ...
                                                            <input type="text" class="form-control editField" value="Start My Deal">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <label for="">Width</label>
                                                                    <input type="text" class="form-control editField" value="250">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <label for="">Height</label>
                                                                    <input type="text" class="form-control editField" value="120">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <label for="">Background Color</label>
                                                                    <input type="text" class="form-control editField" value="#000000">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <label for="">Font Color</label>
                                                                    <input type="text" class="form-control editField" value="#FD123">
                                                                </div>
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="form-check customIconCheck">
                                                                    <input class="form-check-input" type="checkbox" value="" id="checkChecked" checked>
                                                                    <label class="form-check-label" for="checkChecked">
                                                                        Insert an Icon
                                                                    </label>
                                                                </div>
                                                                <div class="iconUploadContainer">
                                                                    <div class="icon-upload-card">
                                                                        <label class="section-title">Upload an Icon</label>

                                                                        <div class="upload-row">
                                                                            <input type="file" id="iconFile" class="input-file">
                                                                            <button class="upload-btn">Upload Icon</button>
                                                                        </div>

                                                                        <label class="section-title">Icon Size (e.g., 150 px)</label>
                                                                        <input type="number" class="input-field" placeholder="150">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <label style="visibility: hidden;">Height</label>
                                                                    <div class="form-check">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="ApplyCta">
                                                                        <button type="button" class="applyCta">Apply Changes</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="tab-contents-cta">
                                                    <p class="ctaText">Reference CTA</p>
                                                    <div class="originalCtaContainer">
                                                        <img src="images/cta-img3.png" alt="">
                                                    </div>
                                                </div>
                                                <div class="tab-contents-cta mt-4">
                                                    <p class="ctaText">Generated CTA</p>
                                                    <div class="originalCtaContainer">
                                                        <img src="images/cta-img3.png" alt="">
                                                    </div>
                                                </div>
                                                <div class="footerCta">
                                                    <button type="button" class="saveCta">Send for Approval</button>
                                                    <button type="button" data-url="{{ $ticket->website_link }}" class="reviewCta">Go to Review</button>
                                                </div>
                                            </div>
                                            <div>
                                              <div class="form-group-control">
    <label for="button_image_url">Button Image URL</label>
    <input type="text" id="button_image_url" class="form-control" readonly>
    <a href="#" id="preview_button_image_url" target="_blank">Preview</a>
</div>

<div class="form-group-control">
    <label for="button_image_url_vdp">VDP Image URL</label>
    <input type="text" id="button_image_url_vdp" class="form-control" readonly>
    <a href="#" id="preview_button_image_url_vdp" target="_blank">Preview</a>
</div>

<div class="form-group-control">
    <label for="button_image_url_cpov">CPOV Image URL</label>
    <input type="text" id="button_image_url_cpov" class="form-control" readonly>
    <a href="#" id="preview_button_image_url_cpov" target="_blank">Preview</a>
</div>
                                        ...
                                        <!-- CUSTOM UI -->
                                          <div class="row">
                                               ...
                                               <div class="col-lg-6">
                                                  ...
                                                  <div class="footerCta">
                                                    <button type="button" class="saveCta_html">Send for Approval</button>
...
<script>
 ...
 //   window.html_setMode = html_setMode;
...
function selectElement(el) {
    ...
    function makeDraggable(el) {
      if (el.hasAttribute && el.hasAttribute('data-background')) return;
    ...
    function downloadSVG() {
      ...
      bgRect.setAttribute('fill', bgColor);
      // FIX: Add border radius to SVG rect
      bgRect.setAttribute('rx', borderR);
...
<script>
  $(document).on('click', '.saveCta', function () {
    ...
    // Ensure rx is set on background rect before export
    let bgRect = $(svgEl).find('rect[data-background="true"]')[0];
    if (bgRect) {
      bgRect.setAttribute('rx', borderRadius || 0);
    }
    let svgContent = svgEl.outerHTML;

    let formData = new FormData();
    formData.append('dealer_code', dealerCode);
...
// Add this for HTML button upload
$(document).on('click', '.saveCta_html', function () {
    let dealerCode = $('#DealerCode').val();
    let buttonText = $('#textContenthtml').val();
    let svgEl = $('#htmlPreview svg')[0];
    let borderRadius = $('#borderRadiushtml').val();
...
<script>
    ...
    // HTML RELATED JS
    /* Prefixed version of your SVG editor JS — all vars & functions use html_ prefix */
...
if (html_languageSelect) {
  html_languageSelect.addEventListener('change', async () => {
    ...
    try {
      ...
      const raw = (document.getElementById('textContenthtml').value || '').trim();
      if (raw) {
...
// ---------- TEXT WRAPPING HELPER ----------
function html_wrapText(text, maxWidth, fontSize, fontFamily) {
  // Split by explicit line breaks first (user-entered newlines)
  const explicitLines = text.split('\n');
  const allLines = [];
  ...
  for (const line of explicitLines) {
    const trimmedLine = line.trim();
    if (trimmedLine === '') { allLines.push(''); continue; }
    const words = trimmedLine.split(' ');
    let currentLine = '';
...
// ---------- TRANSLATION HELPERS ----------
async function html_translateText(original, targetLang) {
  if (!original) return '';
...
async function html_applyTranslation() {
  ...
  const lang = (document.getElementById('languageSelecthtml') && document.getElementById('languageSelecthtml').value) || 'en';
  const texts = svg.querySelectorAll('text');
  for (const txt of texts) {
    const orig = html_originalTexts.get(txt);
    if (orig) {
      txt.textContent = await html_translateText(orig, lang);
    }
  }
}
...
function html_updatePreviewText(translatedOverride) {
  ...
  const rawText = (typeof translatedOverride === 'string' && translatedOverride !== undefined)
    ? translatedOverride
    : (document.getElementById('textContenthtml') && document.getElementById('textContenthtml').value) || '';

  if (!rawText.trim()) return;

  const textModeEl = document.getElementById('textModehtml');
  const textModeVal = textModeEl ? textModeEl.value : 'single';
  const size = parseFloat((document.getElementById('textSizehtml') && document.getElementById('textSizehtml').value) || 16) || 16;
  const color = (document.getElementById('textColorTexthtml') && document.getElementById('textColorTexthtml').value) || '#000';
  const fontFamily = (document.getElementById('fontFamilyhtml') && document.getElementById('fontFamilyhtml').value) || 'Arial, sans-serif';
  const fontWeight = (document.getElementById('fontWeighthtml') && document.getElementById('fontWeighthtml').value) || '400';
  const fontStyle = (document.getElementById('fontStylehtml') && document.getElementById('fontStylehtml').value) || 'normal';
  const letterSpacing = (document.getElementById('letterSpacinghtml') && document.getElementById('letterSpacinghtml').value) || '0';
  const lineHeight = (document.getElementById('lineHeighthtml') && document.getElementById('lineHeighthtml').value) || '1.2';
  const x = (document.getElementById('textXhtml') && document.getElementById('textXhtml').value) || '50';
  const y = (document.getElementById('textYhtml') && document.getElementById('textYhtml').value) || '50';

  if (textModeVal === 'single') {
    const textEl = document.createElementNS('http://www.w3.org/2000/svg', 'text');
    textEl.setAttribute('data-preview', 'true');
    textEl.setAttribute('x', `${x}%`);
    textEl.setAttribute('y', `${y}%`);
    ...
    // multiline preview: wrap and position in viewBox coordinates
    const wrapWidth = parseFloat((document.getElementById('textWrapWidthhtml') && document.getElementById('textWrapWidthhtml').value) || 300) || 300;
    const lines = html_wrapText(rawText, wrapWidth, size, fontFamily);
...
async function html_applyChanges() {
  ...
  // ADD TEXT
  const rawText = (document.getElementById('textContenthtml') && document.getElementById('textContenthtml').value || '').trim();
  if (rawText) {
    const translated = await html_translateText(rawText, lang);
    const size = (document.getElementById('textSizehtml') && document.getElementById('textSizehtml').value) || 16;
    const color = (document.getElementById('textColorTexthtml') && document.getElementById('textColorTexthtml').value) || '#000';
    const fontFamily = (document.getElementById('fontFamilyhtml') && document.getElementById('fontFamilyhtml').value) || 'Arial, sans-serif';
    const fontWeight = (document.getElementById('fontWeighthtml') && document.getElementById('fontWeighthtml').value) || '400';
    const fontStyle = (document.getElementById('fontStylehtml') && document.getElementById('fontStylehtml').value) || 'normal';
    const letterSpacing = (document.getElementById('letterSpacinghtml') && document.getElementById('letterSpacinghtml').value) || 0;
    const lineHeight = (document.getElementById('lineHeighthtml') && document.getElementById('lineHeighthtml').value) || 1.2;
    const textModeVal = (document.getElementById('textModehtml') && document.getElementById('textModehtml').value) || 'single';
    const x = (document.getElementById('textXhtml') && document.getElementById('textXhtml').value) || 50;
    const y = (document.getElementById('textYhtml') && document.getElementById('textYhtml').value) || 50;
    ...
    if (textModeVal === 'single') {
      ...
      const id = 'text-' + Date.now();
      textEl.setAttribute('data-element-id', id);
      html_originalTexts.set(textEl, rawText.toLowerCase().trim());
      ...
      // ---- MULTILINE TEXT ----
      const wrapWidth = parseFloat((document.getElementById('textWrapWidthhtml') && document.getElementById('textWrapWidthhtml').value) || 300) || 300;
      const lines = html_wrapText(translated, wrapWidth, size, fontFamily);
      ...
      html_originalTexts.set(textEl, rawText.toLowerCase().trim());
      html_makeDraggable(textEl);
    }
  }

  // ADD ICON (text-based icon or uploaded images handled elsewhere)
  if (html_selectedIcon) {
    const size = (document.getElementById('iconSizehtml') && document.getElementById('iconSizehtml').value) || 120;
    const xPx = (document.getElementById('iconXhtml') && document.getElementById('iconXhtml').value) || 50;
    const yPx = (document.getElementById('iconYhtml') && document.getElementById('iconYhtml').value) || 50;

    const svgEl = document.querySelector('#htmlPreview svg');
...
function html_makeSelectable(el) {
  el.addEventListener("mousedown", e => {
    if (html_currentMode === "edit") {
      html_selectElement(el);
      e.stopPropagation();
    }
  });
}

function html_selectElement(el) {
  ...
  parent.insertBefore(html_selectionBox, el);
    ...
    function html_updateElementList() {
      const container = document.getElementById('elementListhtml');
      if (!container) return;
      if (html_addedElements.length === 0) {
        container.innerHTML = '<p style="text-align:center; color:#94a3b8; font-size:0.8rem;">No elements added</p>';
        return;
      }
      container.innerHTML = '';
      html_addedElements.forEach(item => {
        ...
        const contentShort = (item.content || '').toString().substring(0, 15);
        div.innerHTML = `<span>${item.type}: ${contentShort}${(item.content||'').toString().length > 15 ? '...' : ''}</span>
                     <button class="delete-btn" data-el-id="${item.id}">Delete</button>`;
        const btn = div.querySelector('button.delete-btn');
        btn.addEventListener('click', () => {
      html_deleteAddedElement(item.id);
    });
        container.appendChild(div);
      });
    }

    window.html_deleteAddedElement = function (id) {
      const el = document.querySelector(`[data-element-id="${id}"]`);
      if (el) el.remove();
      html_addedElements = html_addedElements.filter(item => item.id !== id);
      html_updateElementList();
    ...
    function html_clearAllElements() {
      if (html_addedElements.length === 0) {
        alert('No elements to clear!');
        return;
      }
    ...
    // ---------- DRAG FUNCTIONALITY ----------
    function html_makeDraggable(el) {
      if (el.hasAttribute && el.hasAttribute('data-background')) return;
...
document.addEventListener('mousemove', function (e) {
  ...
  if (html_dragged.tagName === 'text') {
    const hasMultiline = html_dragged.querySelector && html_dragged.querySelector('tspan');
    if (hasMultiline) {
...
function html_reapplyInteractivity() {
  ...
  svg.querySelectorAll('text, circle, rect, path, polygon, line, ellipse, polyline, image')
    .forEach(el => {
      if (!el.hasAttribute('data-background')) {
        html_makeSelectable(el);
      }
    });

  svg.querySelectorAll('[data-element-id]').forEach(el => {
    html_makeDraggable(el);
  });
...
function html_updateSVGViewBox() {
  const svg = document.querySelector('#htmlPreview svg');
  if (!svg) return;
  const newW = parseFloat((document.getElementById('widthInputhtml') && document.getElementById('widthInputhtml').value) || svg.getAttribute('width')) || 500;
  const newH = parseFloat((document.getElementById('heightInputhtml') && document.getElementById('heightInputhtml').value) || svg.getAttribute('height')) || 500;
  svg.setAttribute('viewBox', `0 0 ${newW} ${newH}`);
  svg.setAttribute('width', String(newW));
  svg.setAttribute('height', String(newH));
  svg.style.width = `${newW}px`;
...
function html_resizeInternalShapes() {
  const svg = document.querySelector('#htmlPreview svg');
  if (!svg) return;
  const newW = parseFloat((document.getElementById('widthInputhtml') && document.getElementById('widthInputhtml').value) || svg.getAttribute('width')) || 500;
  const newH = parseFloat((document.getElementById('heightInputhtml') && document.getElementById('heightInputhtml').value) || svg.getAttribute('height')) || 500;
...
function html_downloadSVG() {
  ...
  const borderR = parseFloat((document.getElementById('borderRadiushtml') && document.getElementById('borderRadiushtml').value) || 3) || 3;
  const borderColor = (document.getElementById('borderColorTexthtml') && document.getElementById('borderColorTexthtml').value) || '#000';
  const bgColor = (document.getElementById('bgColorTexthtml') && document.getElementById('bgColorTexthtml').value) || '#fff';
...
// ---------- INITIALISE ----------
document.addEventListener('DOMContentLoaded', () => {
  const defaultBtn = document.querySelector('.mode-btn:not(.erase-mode)');
  if (defaultBtn) defaultBtn.classList.add('active');
  html_currentMode = 'edit';

  ['widthInputhtml', 'heightInputhtml', 'borderWidthhtml', 'borderRadiushtml', 'borderColorTexthtml', 'bgColorTexthtml','iconSizehtml'].forEach(id => {
    const el = document.getElementById(id);
    if (el) el.addEventListener('input', () => {
      try { html_applyVisualStyles(); } catch (e) {}
      try { html_updateSVGViewBox(); } catch (e) {}
      try { html_resizeInternalShapes(); } catch (e) {}
      try { html_updateUploadedImagesSize(); } catch (err) {}
    });
  });

  ['textContenthtml','textXhtml','textYhtml','textSizehtml','fontFamilyhtml','fontWeighthtml','fontStylehtml','letterSpacinghtml','lineHeighthtml','textModehtml','textWrapWidthhtml','textColorTexthtml','textColorPickerhtml'].forEach(id => {
    const el = document.getElementById(id);
    if (!el) return;
    const ev = el.tagName.toLowerCase() === 'select' || el.type === 'file' ? 'change' : 'input';
    el.addEventListener(ev, () => {
